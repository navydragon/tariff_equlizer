"""
Management команда для создания базового сценария "Базовый сценарий" 2026-2035.
"""
import os
...
class Command(BaseCommand):
    help = 'Создает базовый сценарий "Базовый сценарий" с годами 2026-2035'
            ...
            scenario = repository.create(
                {
                    ...
                    "description": (
                        "Базовый сценарий для работы с тарифами на период 2026-2035"
                    ),
                    "start_year": 2026,
                    "end_year": 2035,
                    "route_set": route_set,
