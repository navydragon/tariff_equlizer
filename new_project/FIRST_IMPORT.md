...
### 6.1. Экспорт совпадений (для проверки)
...
Войти под `admin`, выбрать сценарий с набором **RZD_2026**, открыть «Экономика грузов» (`/route-analysis/`) — в поиске маршрутов видны только записи с заполненной рыночной ценой.
