...
python manage.py import_ipem_forest_routes --scenario-id 1 --route-set-code RZD_2026
python manage.py import_ipem_other_routes --scenario-id 1 --route-set-code RZD_2026
...
Проверка без записи: добавьте `--dry-run`.
