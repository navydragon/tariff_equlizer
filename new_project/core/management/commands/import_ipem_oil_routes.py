...
from scenarios.domain.services.ipem_oil_import import (
    import_ipem_oil_bundle,
)
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser) -> None:
        parser.add_argument(
            "--file",
            dest="file_path",
            default="../data/ipem/Нефть_эластика.xlsx",
            help="Путь к XLSX IPEM (нефть)",
        )
        parser.add_argument(
            "--route-set-code",
            dest="route_set_code",
